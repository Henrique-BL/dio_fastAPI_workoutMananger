...
Revision ID: a1557a2cf3c7
Revises: 
Create Date: 2024-05-25 18:14:03.864735
...
def upgrade() -> None:
    ...
    sa.Column('propietario', sa.String(length=25), nullable=False),
    sa.Column('id', sa.UUID(), nullable=False),
    sa.PrimaryKeyConstraint('pk_id'),
    sa.UniqueConstraint('nome')
    )
    ...
    sa.Column('centro_treinamenento_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['categoria_id'], ['categorias.pk_id'], ),
    sa.ForeignKeyConstraint(['centro_treinamenento_id'], ['centros_treinamento.pk_id'], ),
    sa.PrimaryKeyConstraint('pk_id'),
